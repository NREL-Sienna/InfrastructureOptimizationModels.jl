...
pages = OrderedDict(
    ...
    "Reference" => Any[
        ...
        "Piecewise Linear Objective Functions" => "explanation/piecewise_linear_objective_functions.md",
        "Time-Varying Objective Functions" => "explanation/time_varying_objective_functions.md",
