...
# really should be ::Type{PSY.ThermalGen}, but avoiding PSY types. 
# shouldn't have non-thermal with thermal formulation, so this is fine.
_sos_status(::Type{<:IS.InfrastructureSystemsComponent}, ::AbstractThermalUnitCommitment) =
